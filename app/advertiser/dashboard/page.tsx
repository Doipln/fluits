...
import { TrendingUp, Users, Heart, ChevronRight, Check, MapPin, Home } from "lucide-react"
...
export default function AdvertiserDashboard() {
  ...
  const handleWriteButtonClick = () => {
    console.log("[v0] Write button clicked")
      ...
      <main className="px-4 pt-10 pb-6 space-y-12">
        <section>
          <div className="flex items-center justify-between mb-1">
            ...
            >
              <Link href="/advertiser/trending-influencers" className="flex items-center gap-1">
        ...
        <section>
          <div className="flex items-center justify-between mb-1">
            ...
            <Button
              ...
              className="text-gray-400 hover:text-gray-600 text-xs px-2 py-1 h-7 -mr-2 transition-colors duration-200"
            >
              <Link href="/advertiser/trending-campaigns" className="flex items-center gap-1">
                더보기 <ChevronRight className="w-3 h-3 -ml-0.5" />
              </Link>
            </Button>
          </div>
