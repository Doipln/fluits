...
import { Users, ChevronRight, Check, MapPin, Heart, Home } from "lucide-react"
...
const bannerSlides = [
  {
    id: 1,
    content: "Banner Slide 1",
  },
  {
    id: 2,
    content: "Banner Slide 2",
  },
  {
    id: 3,
    content: "Banner Slide 3",
  },
]
...
export default function InfluencerDashboard() {
  ...
  const hotInfluencers = allInfluencers.slice(0, 4)
      ...
      <main className="px-4 py-6 space-y-12">
        <section>
          <div className="flex items-center justify-between mb-1">
            ...
            >
              <Link href="/influencer/trending-campaigns" className="flex items-center gap-1">
              ...
              campaigns
                ...
                .map((campaign, index) => (
                  <div key={campaign.id}>
                    ...
                    {index < campaigns.slice(0, 5).length - 1 && <div className="border-b border-gray-100" />}
                  </div>
                ))
            ) : (
        ...
        <section>
          <div className="flex items-center justify-between mb-1">
            ...
            <Button
              ...
              className="text-gray-400 hover:text-gray-600 text-xs px-2 py-1 h-7 -mr-2 transition-colors duration-200"
            >
              <Link href="/influencer/trending-influencers" className="flex items-center gap-1">
                더보기 <ChevronRight className="w-3 h-3 -ml-0.5" />
              </Link>
            </Button>
          </div>
